...
import com.uscoproyecto.hibrido.repository.postgresql.ResenaRepository;
...
public class ReservaController {
    ...
    public String chat(@PathVariable Long reservaId, Model model, Authentication auth) {
        ...
        model.addAttribute("yaReseno", resenaRepository.existsByReservaId(reservaId));
    ...
    public String enviarMensaje(@PathVariable Long reservaId, @RequestParam String contenido, Authentication auth) {
    ...
    public String negociar(@PathVariable Long reservaId, @RequestParam BigDecimal nuevoPrecio,
                           Authentication auth, RedirectAttributes ra) {
    ...
    public String finalizar(@PathVariable Long reservaId, Authentication auth, RedirectAttributes ra) {
        ...
        ra.addFlashAttribute("exito", "Servicio finalizado. ¡No olvides dejar tu reseña!");
        return "redirect:/reservas/chat/" + reservaId;
    }
